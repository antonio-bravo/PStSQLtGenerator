function New-PSTGObjectExistenceTest {
    ...
    process {
        ...
        if ($InputObject) {
            ...
            $objects += $server.Databases[$Database].ExtendedStoredProcedures | Where-Object { $_.Name -in $InputObject -and $_.IsSystemObject -eq $false } | Where-Object SchemaName -NotIn $SkipDBTests.name | Select-Object Schema, Name, @{Name = "ObjectType"; Expression = { "Extended Stored Procedure" } }

            # Get the sequences
            $objects += $server.Databases[$Database].Sequences | Where-Object Name -in $InputObject | Where-Object SchemaName -NotIn $SkipDBTests.name | Select-Object Schema, Name, @{Name = "ObjectType"; Expression = { "Sequence" } }
            ...
            # Get tables
            $objects += $server.Databases[$Database].Tables | Where-Object Name -in $InputObject | Where-Object SchemaName -NotIn $SkipDBTests.name | Select-Object Schema, Name, @{Name = "ObjectType"; Expression = { "Table" } }

            # Get user defined data types
            $objects += $server.Databases[$Database].UserDefinedDataTypes | Where-Object { $_.Name -in $InputObject -and $_.IsSystemObject -eq $false } | Where-Object SchemaName -NotIn $SkipDBTests.name | Select-Object Schema, Name, @{Name = "ObjectType"; Expression = { "User Defined Data Type" } }

            # Get user defined functions
            $objects += $server.Databases[$Database].UserDefinedFunctions | Where-Object { $_.Name -in $InputObject -and $_.IsSystemObject -eq $false } | Where-Object SchemaName -NotIn $SkipDBTests.name | Select-Object Schema, Name, @{Name = "ObjectType"; Expression = { "User Defined Function" } }

            # Get user defined table types
            $objects += $server.Databases[$Database].UserDefinedTableTypes | Where-Object { $_.Name -in $InputObject -and $_.IsSystemObject -eq $false } | Where-Object SchemaName -NotIn $SkipDBTests.name | Select-Object Schema, Name, @{Name = "ObjectType"; Expression = { "User Defined Table Type" } }
            ...
            # Get the extended stored procedures
            $objects += $server.Databases[$Database].ExtendedStoredProcedures | Where-Object { $_.IsSystemObject -eq $false } | Where-Object SchemaName -NotIn $SkipDBTests.name | Select-Object Schema, Name, @{Name = "ObjectType"; Expression = { "Extended Stored Procedure" } }
            ...
            # Get tables
            $objects += $server.Databases[$Database].Tables | Where-Object SchemaName -NotIn $SkipDBTests.name | Select-Object Schema, Name, @{Name = "ObjectType"; Expression = { "Table" } }

            # Get user defined data types
            $objects += $server.Databases[$Database].UserDefinedDataTypes | Where-Object { $_.IsSystemObject -eq $false } | Where-Object SchemaName -NotIn $SkipDBTests.name | Select-Object Schema, Name, @{Name = "ObjectType"; Expression = { "User Defined Data Type" } }

            # Get user defined functions
            $objects += $server.Databases[$Database].UserDefinedFunctions | Where-Object { $_.IsSystemObject -eq $false } | Where-Object SchemaName -NotIn $SkipDBTests.name | Select-Object Schema, Name, @{Name = "ObjectType"; Expression = { "User Defined Function" } }

            # Get user defined table types
            $objects += $server.Databases[$Database].UserDefinedTableTypes | Where-Object { $_.IsSystemObject -eq $false } | Where-Object SchemaName -NotIn $SkipDBTests.name | Select-Object Schema, Name, @{Name = "ObjectType"; Expression = { "User Defined Table Type" } }
        ...
        if ($Schema) {
            $objects = $objects | Where-Object Schema -in $Schema | Where-Object SchemaName -NotIn $SkipDBTests.name
        }

        if ($Object) {
            $objects = $objects | Where-Object Name -in $Object | Where-Object SchemaName -NotIn $SkipDBTests.name
        }
